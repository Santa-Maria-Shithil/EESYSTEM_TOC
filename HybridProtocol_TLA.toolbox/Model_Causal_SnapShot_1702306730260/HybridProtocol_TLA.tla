...
Next == 
    ...
    \/ (* Disjunct to prevent deadlock on termination *)
      ((\A r \in Replicas: cmdLog[r].status = "causally-committed") /\ UNCHANGED vars)
...
Termination == <>(\A r \in Replicas: cmdLog[r].status = "causally-committed")
...
\* Last modified Mon Dec 11 09:58:30 EST 2023 by santamariashithil
