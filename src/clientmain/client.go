...
var writes *int = flag.Int("w", 10, "Percentage of updates (writes). Defaults to 100%.")
...
var numKeys *uint64 = flag.Uint64("numKeys", 100000000000, "Number of keys in simulated store.") //update from 1000000 to 100000000
