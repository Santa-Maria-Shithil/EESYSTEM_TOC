...
var thrifty *bool = flag.Bool("thrifty", true, "Use only as many messages as strictly required for inter-replica communication.")
var exec *bool = flag.Bool("exec", true, "Execute commands.")
var dreply *bool = flag.Bool("dreply", true, "Reply to client only after command has been executed.")
